...
class DeliveryService:
    ...
    def _managed_smtp_route_resolution_metadata(self, record, selected_route) -> dict[str, object]:
        ...
        return {
            ...
            'mta_rule_hit_provider_preference_mode': route.routing_rule_provider_preference_mode,
            'mta_provider_preference_fallback_used': route.provider_preference_fallback_used,
            'mta_provider_preference_fallback_provider': route.provider_preference_fallback_provider,
            'mta_provider_preference_fallback_node_name': route.provider_preference_fallback_node_name,
            ...
            'mta_node_selection_membership_id': str(route.mta_node_selection_membership_id)
            if route.mta_node_selection_membership_id
            else None,
