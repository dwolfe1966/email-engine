...
class DeliveryAttemptEvidenceSummaryRead(BaseModel):
    ...
    top_send_types: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_sender_domains: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    ...
    top_node_skipped_counts: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_node_selection_priorities: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_node_selection_weights: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_submission_providers: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_submission_hosts: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_submission_ports: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_mta_hostnames: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_pool_capacity_statuses: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_pool_available_node_counts: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
    top_pool_required_node_counts: list[DeliveryAttemptEvidenceCountRead] = Field(default_factory=list)
...
class ManagedSmtpDeploymentNodeSummary(BaseModel):
    ...
    agent_heartbeat_status_label: str = 'Missing'
    ...
    agent_queue_status_label: str = 'Unknown'
    ...
    agent_log_issue_status_label: str = 'Clear'
...
class ManagedSmtpProviderReadinessRead(BaseModel):
    ...
    port25_status_label: str = 'Unknown'
    rdns_status_label: str = 'Unknown'
    blockers: list[str] = Field(default_factory=list)
    blocker_labels: list[str] = Field(default_factory=list)
    next_action: str = 'No provider action required.'
...
class ManagedSmtpDeploymentSummaryRead(BaseModel):
    ...
    provider_readiness: list[ManagedSmtpProviderReadinessRead] = Field(default_factory=list)
